...
export function BlogTable<TData, TValue>({
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      <div
        className={cn(
          "flex lg:flex-row flex-col justify-between gap-4 py-4",
          hideFilter && "hidden"
        )}
      >
        <InputIcon
      ...
      <div className="table-box border rounded-xl w-full overflow-hidden">
        <Table>
          <TableHeader>
      ...
      <div
        className={cn(
          "flex justify-end items-center space-x-2 py-4",
