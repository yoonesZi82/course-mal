  ...
  return (
    ...
    >
      ...
      >
        ...
        <RemoveIcon className="hover:stroke-destructive w-3 h-3 duration-200 ease-in-out" />
      </button>
    </div>
  );
});
  ...
  ({ className, parentclass, dropmsg, children, ...props }, ref) => {
    ...
    return (
      ...
      >
        <div
          className={cn(
            "w-full rounded-lg flex justify-center items-center h-full transition-colors duration-300 ease-in-out",
        ...
        >
          {children}
          {dropzoneState.isDragActive && (
            <div className="absolute inset-0 flex justify-center items-center bg-primary-foreground/60 backdrop-blur-sm rounded-lg">
